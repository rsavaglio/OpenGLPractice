...
int main(void)
{
    ...
    // Set Data 
    glBufferData(GL_ARRAY_BUFFER, 8 * sizeof(float), vertexBufferData, GL_STATIC_DRAW);
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, 6 * sizeof(unsigned int), indexBufferData, GL_STATIC_DRAW);
